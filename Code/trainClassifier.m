...
predictorNames = {'region', 'avg_duration', 'avg_distance', 'avg_fare', 'DayOfWeek', 'dayofyear', 'isholiday', 'hourofday'};
...
trainedClassifier.RequiredVariables = {'DayOfWeek', 'avg_distance', 'avg_duration', 'avg_fare', 'dayofyear', 'hourofday', 'isholiday', 'region'};
